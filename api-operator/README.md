...
```bash
operator-sdk init --domain api.test  --repo github.com/dkr290/simple-operator/api-operator
...
```bash
operator-sdk create api --group apps.api.test --version v1alpha1 --kind simple-api --resource --controller
